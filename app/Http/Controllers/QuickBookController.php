...
class QuickBookController extends Controller
{
  ...
  public function qboSuccess(){
    ...
    if (isset($taxCode)) {
      ...
      flash()->overlay('Oops', 'Your Current Sales Tax for Pockeyt Pay based on your business location is ' . $user->profile->tax_rate / 100 . '%. This Does Not match your Quickbooks Sales Tax. Please make sure your location is correct on Pockeyt or your Sales Tax on QuickBooks is correct');

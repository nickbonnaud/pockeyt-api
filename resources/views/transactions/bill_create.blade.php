              ...
              <div class="col-md-12">
                <form class="form-horizontal">
                  ...
                  <div class="form-group" style="margin-left: 15%;">
                    ...
                    <div class="col-sm-10">
                      <input v-model="price" type="tel" name="price" class="form-control" style="width: 50%;" id="inputPrice" placeholder="Price" pattern="^\\$?(([1-9](\\d*|\\d{0,2}(,\\d{3})*))|0)(\\.\\d{1,2})?$" step="any" required>
                    </div>
                  </div>

<div class="box-body">
	...
	<div class="form-group" v-if= "selection == 'increments'">
		...
		<div class="input-group col-xs-5 col-md-3">
			...
			<input class="form-control" type="number" name="purchases_required" id="purchases_required" value="{{ $loyaltyProgram->purchases_required }}">
		</div>
	</div>
	<div class="form-group" v-if= "selection == 'amounts'">
		...
		<div class="input-group col-xs-5 col-md-3">
			<span class="input-group-addon">$</span>
			<input class="form-control" type="number" name="amount_required" id="amount_required" pattern="^\\$?(([1-9](\\d*|\\d{0,2}(,\\d{3})*))|0)(\\.\\d{1,2})?$" step="any" value="{{ $loyaltyProgram->amount_required }}">
		</div>
	</div>
</div>

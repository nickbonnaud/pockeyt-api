  ...
  @yield('content')
      ...
      <aside class="control-sidebar control-sidebar-dark">
        ...
        <div class="tab-content">
          ...
          <h3 class="control-sidebar-heading" v-if="transactionsPending.length != 0">Finalized Transactions</h3>
            <h3 class="control-sidebar-heading" v-else>No Finalized Transactions</h3>
            <ul class="control-sidebar-menu">
